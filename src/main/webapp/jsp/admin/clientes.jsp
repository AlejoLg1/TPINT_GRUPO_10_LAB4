...
<div class="container mt-5">
    <div class="card shadow-sm">
        <div class="card-body">
            ...
            <!-- 🔎 Filtros -->
            <form action="${pageContext.request.contextPath}/ServletListarCliente" method="get" class="row g-3 mb-4">
                <div class="col-md-3">
                ...
                <div class="col-md-2">
                    <a href="${pageContext.request.contextPath}/ServletListarCliente" class="btn btn-outline-secondary w-100">Limpiar</a>
                </div>
            </form>
                            ...
                            <% if (c.isEstado()) { %>
                                <button 
                                    ...
                                    onclick="abrirConfirmacion({
                                        ...
                                        mensaje: '¿Estás seguro que deseas desactivar al cliente <%= c.getNombre() %> <%= c.getApellido() %>?', 
                            ...
                            <% } else { %>
                                <button 
                                    ...
                                    onclick="abrirConfirmacion({
                                        ...
                                        mensaje: '¿Deseas activar nuevamente al cliente <%= c.getNombre() %> <%= c.getApellido() %>?', 
                                        botonTexto: 'Activar',
