	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		if (request.getParameter("btnUsuario") != null) {
			...
			try {
				...
				if (tipoUser == null || username == null || pass == null || passRepetida == null || tipoUser.isEmpty()
						|| username.isEmpty() || pass.isEmpty() || passRepetida.isEmpty()) {
				...
				if (tipoUser.equals("Admin") && !auth.validarRolAdmin(usuario)) {
